...
using static IndianCensusAnalyser.CensusAnalyser;
//using Assert = NUnit.Framework.Assert;

namespace TestIndianCensus
{
    public class UnitTest1
    {
        ...
        static string indianStateCensusFilePath = @"C:\Users\ADMIN\source\repos\IndianCensusAnalyserday29\IndianCensusAnalyser\CsvFile\IndianPopulation.csv";
       
        static string indianStateCodeFilePath = @"C:\Users\ADMIN\source\repos\IndianCensusAnalyserday29\IndianCensusAnalyser\CsvFile\IndianState.csv";
        //file path for wrong header csv file
        static string wrongHeaderIndianStateCensusFilePath = @"C:\Users\ADMIN\source\repos\IndianCensusAnalyserday29\IndianCensusAnalyser\CsvFile\CensusWrongStateData.csv";
        //file path for wrong header csv file
        static string wrongHeaderIndianStateCodeFilePath = @"C:\Users\ADMIN\source\repos\IndianCensusAnalyserday29\IndianCensusAnalyser\CsvFile\CensusWrongStateData.csv";
        //file path for wrong delimitercsv file
        static string wrongDelimiterIndianStateCensusFilePath = @"C:\Users\ADMIN\source\repos\IndianCensusAnalyserday29\IndianCensusAnalyser\CsvFile\DelimeIndiaStateCen.csv";
        //file path for wrong delimeter csv file
        static string wrongDelimiterIndianStateCodeFilePath = @"C:\Users\ADMIN\source\repos\IndianCensusAnalyserday29\IndianCensusAnalyser\CsvFile\DelimeIndiaStateCode.csv";
        //file path for wrong state census csv file
        static string wrongIndianStateCensusFilePath = @"C:\Users\ADMIN\source\repos\IndianCensusAnalyserday29\IndianCensusAnalyser\CsvFile\CensusWrongStateData.csv";
        //file path for wrong state code csv file
        static string wrongIndianStateCodeFilePath = @"C:\Users\ADMIN\source\repos\IndianCensusAnalyserday29\IndianCensusAnalyser\CsvFile\WrongIndiaStateCodeData.csv";
        //file path for wrong state file type
        static string wrongIndianStateCensusFileType = @"C:\Users\ADMIN\source\repos\IndianCensusAnalyserday29\IndianCensusAnalyser\CsvFile\IndianState.txt";
        //file path for wrong state code file type
        static string wrongIndianStateCodeFileType = @"C:\Users\ADMIN\source\repos\IndianCensusAnalyserday29\IndianCensusAnalyser\CsvFile\IndianState.txt";
